...
/* 
 ...
 java.util : 객체지향
 StreamAPI 
 File, FlieReader (일반) -> Fileinputstream
 FileWriter -> FileOutputStream
 
 1. 메소드에 throws Exeption을 사용시 해당 메소드를 외부에서 호출 시 무조건 try ~ catch를 사용해야함
 2. 해당 메소드에서 try~catch를 사용할 경우 호출 받은 메소드에서 throws를 사용했을때.
...
public class file1 {
	...
	public static void main(String[] args){
		...
		catch(Exception e) { //여러번 사용 가능
			//Exception은 여러가지 오류사항 예외처리를 모두 확인 할 수 있는 Default 클래스.
			//System.out.println("해당 파일을 찾을 수 없습니다!!");
